...
const Block_1 = () => {
	...
	return(
		<div className = 'dis-container'>
			<h2 className = 'media-title pt50 pl150 left gradient '>Nova is your trustable Stretch Ceiling</h2>
			...
			<div class="container mobile-2">
			  <ul class="cards">
			    <li class="card">
			      <div className = 'starCeiling'>
			        <h3 class="card-title">title</h3>
			      </div>
			    </li>
			    <li class="card">
			      <div className = 'matteCeiling'>
			        <h3 class="card-title">title</h3>
			...
			<div className = 'media-gallery mobile-1'>
